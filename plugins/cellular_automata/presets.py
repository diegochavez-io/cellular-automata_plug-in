...
PRESETS = {
    ...
    "amoeba": {
        ...
        "R": 15, "T": 25, "mu": 0.222, "sigma": 0.045,
        "kernel_peaks": [0.5, 0.85], "kernel_widths": [0.15, 0.10],
        "seed": "blobs", "density": 0.35,
        "hue": 0.54, "brightness": 1.51, "speed": 1.56,
        "flow_swirl": 0.50, "flow_rotate": 0.35, "flow_vortex": 0.30,
        "flow_bubble": 0.20, "flow_radial": -0.30, "flow_ring": -0.20,
    },
    "coral": {
        "engine": "lenia",
        "name": "Lenia Branch",
